...
public class TicTacToe extends Application {
    ...
    private static final Image bgImage = new Image("file:src/main/resources/table.jpg");
    private static final Image x = new Image("file:src/main/resources/x.png");
    private static final Image o = new Image("file:src/main/resources/O.png");
    ...
    public void start(Stage primaryStage) throws Exception {
        BackgroundSize backgroundSize = new BackgroundSize(1000, 700, true, true, true, false);
        ...
        row3.setPrefHeight(200);
        RowConstraints row4 = new RowConstraints();
        row4.setPrefHeight(200);
        ...
        newGame.setOnAction(event -> {
            ...
            Platform.runLater(() -> {
                try {
                    String text = !isX ? "Wygral X" : "Wygral O";
                    output.add(text);
                    move = 0;
                    hard = false;
                    isX = true;
        ...
        mode.setStyle("-fx-background-color:yellow;");
        ...
        ranking.setStyle("-fx-background-color: yellow;");
        ...
        type.setStyle("-fx-background-color: yellow;");
            ...
            for (int j = 0; j < 3; j++) {
                ...
                button.setOnAction(event -> {
                    if (isX) {
                        ...
                        xView.setFitHeight(100);
                        xView.setFitWidth(100);
